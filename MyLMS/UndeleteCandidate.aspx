<%@ Page Title="" Language="C#" MasterPageFile="~/MyLMS/MasterPageMain.master" AutoEventWireup="true" CodeFile="UndeleteCandidate.aspx.cs" Inherits="_Default" %>
                        ...
                        <div class="box">
                            ...
                            <div class="container-fluid">
                                ...
                                <div class="col-md-3 col-sm-6">
                                    ...
                                    <asp:TextBox ID="TextBox2" placeholder="Search" runat="server"></asp:TextBox>
                                </div>
                            ...
                            <div class="box-body">
                                ...
                                <!-- /.box-body -->
                                <asp:Button ID="BtnUnDeleteCan" runat="server" CssClass="btn btn-danger" Text="UnDelete" />
                            </div>
                            <!-- /.box -->
